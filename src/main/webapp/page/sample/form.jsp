			...
			<div class="page-content">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12">
								<h4 style="margin-bottom:0px;padding-bottom:10px;border-bottom: 1px solid #e3e3e3;">数据创建</h4>
							</div>
						</div>
						<form class="form-horizontal" role="form" id="form1" style="padding-top:10px ;" action="/sample/save" method="post" enctype="multipart/form-data">
							<div class="row ">
								<div class="col-md-5">
										...
										<div class="col-sm-9">
											<div class="control-group">
												<label class="checkbox-inline">
													<input type="checkbox" id="hobbies1" name="hobbies" value="爬山"> 爬山
												</label>
												<label class="checkbox-inline">
													<input type="checkbox" id="hobbies2" name="hobbies" value="上树"> 上树
												</label>
											</div>
										</div>
									</div>	
								...
								<div class="col-md-4">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="height" name="height" placeholder="身高(米)" />
										</div>
									</div>
								...
								<div class="col-md-3">
									<div class="form-group" >
										...
										<!-- 图片预览 -->
										<img id="preview" class="img-responsive img-thumbnail center-block"  style="width: 140px;height: 170px;">									    	
									</div>
								</div>
							</div>
